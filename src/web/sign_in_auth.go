...
func (s *Server) handleStartSignInRequest(w http.ResponseWriter, r *http.Request) {
	if s.auth == nil {
		http.NotFound(w, r)
		return
	}
...
func (s *Server) handleSignInRequestQRCode(w http.ResponseWriter, r *http.Request) {
	if s.auth == nil {
		http.NotFound(w, r)
		return
	}
...
func (s *Server) handleSignInRequestSession(w http.ResponseWriter, r *http.Request) {
	if s.auth == nil {
		http.NotFound(w, r)
		return
	}
...
func (s *Server) handleSignInApproval(w http.ResponseWriter, r *http.Request) {
	if s.auth == nil {
		http.NotFound(w, r)
		return
	}
...
func (s *Server) handleApproveSignInRequest(w http.ResponseWriter, r *http.Request) {
	if s.auth == nil {
		http.NotFound(w, r)
		return
	}
...
func (s *Server) handleSignInApprovalPage(w http.ResponseWriter, r *http.Request) {
	if s.auth == nil {
	...
	http.ServeFile(w, r, "web/client/index/sign-in-approval.html")
}
