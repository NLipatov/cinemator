...
type TorrentManager interface {
	...
	PrepareHlsStream(ctx context.Context, magnet, playbackSession string, fileIndex, audioTrack, subtitleTrack int, startSeconds float64, forceTranscode bool) (playlistPath string, err error)
	...
	ReleaseHlsSession(playbackSession string)
