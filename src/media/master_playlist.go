...
func buildMasterPlaylist(videoURI, sharedPrefix string, info MediaInfo, selection StreamSelection) string {
...
func selectedBitmapSubtitle(info MediaInfo, selection StreamSelection) bool {
