...
committed target or cancel preparation of its missing presentation. A decoded
frame from the old position that arrives after the commit also MUST NOT take
ownership of the playhead or satisfy the seek-to-first-frame measurement.
